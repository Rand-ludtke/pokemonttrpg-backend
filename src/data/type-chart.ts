...
export function typeEffectiveness(moveType: TypeName, targetTypes: TypeName[]): number {
  const chart = TYPE_CHART[moveType] || {};
  return targetTypes.reduce((mult, t) => mult * (chart[t] ?? 1), 1);
}
